                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Renovation List</h6>
                        </div>
                    </div>
...
@push('script')
<script> 
   $(document).on('click', '.deleteRenovation', function() {
            var id = $(this).data('id');
            swal.fire({
    ...
    $(function () {
        var table = $('.data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('client.renovation.index') }}",
            columns: [
